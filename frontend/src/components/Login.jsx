        ...
        <div className="max-w-screen-xl m-4 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          ...
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            ...
            <div className="mt-6 flex flex-col items-center">
              ...
              {errors &&<h2 className="mt-4 font-bold text-red-800">{errors}</h2>}
              <div className="w-full flex-1 mt-8">
                <div className="mx-auto max-w-xs">
                  ...
                  />
                  <button className="mt-5 tracking-wide font-semibold bg-orange-700 text-gray-100 w-full py-4 rounded-lg hover:bg-orange-800 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none" 
                  onClick={loginFn}>
                    <svg
